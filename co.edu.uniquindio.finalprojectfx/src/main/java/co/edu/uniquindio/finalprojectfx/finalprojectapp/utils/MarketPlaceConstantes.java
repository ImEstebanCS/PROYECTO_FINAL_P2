...
public class MarketPlaceConstantes {
    ...
    public static final String INGRESE_NOMBRE_VENDEDOR = "Ingrese el nombre del Vendedor";
    public static final String INGRESE_APELIIDO_VENDEDOR = "Ingrese el apellido del Vendedor";
    public static final String INGRESE_CEDULA_VENDEDOR = "Ingrese la cedula del Vendedor";
    public static final String INGRESE_CEDULA_VENDEDOR_ACTUAL = "Ingrese la cedula actual del Vendedor";
    public static final String INGRESE_EDAD_VENDEDOR = "Ingrese la edad del Vendedor";

    public static final String VENDEDOR_CREADO = "El Vendedor se ha creado con éxito";
    public static final String VENDEDOR_NO_CREADO = "No se pudo crear el Vendedor, ya existe¡¡¡¡";

    public static final String VENDEDOR_ENCONTRADO = "Vendedor encontrado: ";
    public static final String VENDEDOR_NO_EXISTE = "El Vendedor no existe";
    ...
    public static final String VENDEDOR_NO_ACTUALIZADO = "No se pudo actualizar el Vendedor,no existe¡¡¡¡";
